...
namespace UILib {
    public class ScrollView : BaseComponent {
        ...
        public ScrollView(ScrollType scrollType) {
            ...
            MakeChild(root, viewport);

            content = new GameObject("Content",
                typeof(RectTransform)
            );
            MakeChild(viewport, content);
